...
class TestSmokeAllTasks(unittest.TestCase):
    ...
    # Vision
    def test_vision_digits(self): self._test_task("digits", "vision")
    def test_vision_usps(self): self._test_task("usps", "vision")
    def test_vision_kmnist(self): self._test_task("kmnist", "vision")
    def test_vision_mnist(self): self._test_task("mnist", "vision")
    def test_vision_fashion(self): self._test_task("fashion_mnist", "vision")
    # def test_vision_svhn(self): self._test_task("svhn", "vision")
    def test_vision_cifar10(self): self._test_task("cifar10", "vision")
    # def test_vision_cifar100(self): self._test_task("cifar100", "vision")

    # LM
    def test_lm_tiny_shakespeare(self): self._test_task("tiny_shakespeare", "lm")
    def test_lm_char_ngram(self): self._test_task("char_ngram", "lm")
