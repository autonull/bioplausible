...
class FailureTracker:
    ...
    def _init_db(self):
        ...
        """)
        conn.execute("CREATE INDEX IF NOT EXISTS idx_failures_model ON failures(model_name)")
        conn.execute("CREATE INDEX IF NOT EXISTS idx_failures_type ON failures(failure_type)")
        conn.execute("CREATE INDEX IF NOT EXISTS idx_failures_timestamp ON failures(timestamp)")
        conn.commit()
        conn.close()
