...
def _bootstrap_package() -> None:
    ...
    package_name = "bioplausible.scientist.evolve"
    ...
    if spec is None or spec.loader is None:
        raise ImportError(
            "Failed to bootstrap the 'bioplausible.scientist.evolve' package"
        )
...
from bioplausible.scientist.evolve.pipeline import Pipeline
