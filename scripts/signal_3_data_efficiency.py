...
def main():
    ...
    for algo in algorithms:
        for frac in data_fractions:
            ...
            cfg = RunConfig(
                seed=42, device="auto", output_dir=f"{output_dir}/{algo}_{task}_frac{frac}_signal_3",
            ...
            try:
                ...
                results.append({"model": algo, "task": task, "data_fraction": frac, "success": True, "final_score": score})
            except Exception as e:
                results.append({"model": algo, "task": task, "data_fraction": frac, "success": False, "error": str(e)})
