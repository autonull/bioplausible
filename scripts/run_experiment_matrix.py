...
def main():
    ...
    for algo in algorithms:
        ...
        for task in tasks:
            ...
            domain = "vision"
            if task == "tiny_shakespeare": domain = "lm"
            elif task == "cartpole": domain = "rl"
            elif task == "breast_cancer": domain = "tabular"
            elif task == "cora": domain = "graph"
            ...
            if spec.model_type == "graph_eqprop" and domain == "graph":
                ...
                is_compat = True
            elif algo in ["forward_forward", "pepita", "diff_target_prop", "three_factor_hebbian"] and domain == "vision":
                is_compat = True
            ...
            cfg = RunConfig(
                ...
                trainer=RunConfigTrainer(epochs=1, batches_per_epoch=20, track_energy=True)
            )
