...
def main():
    ...
    for algo in algorithms:
        for task in tasks:
            ...
            cfg = RunConfig(
                seed=42, device="auto", output_dir=f"{output_dir}/{algo}_{task}_signal_1",
            ...
            try:
                ...
                results.append({"model": algo, "task": task, "success": True, "final_score": score})
            except Exception as e:
                results.append({"model": algo, "task": task, "success": False, "error": str(e)})
