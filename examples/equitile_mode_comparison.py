...
def compare_modes():
    ...
    print(f"  PC mode: {sum(history_pc['time_per_epoch'])/len(history_pc['time_per_epoch']):.2f}s")
    print(f"  EP mode: {sum(history_ep['time_per_epoch'])/len(history_ep['time_per_epoch']):.2f}s")
    print()
    ...
    print(f"  PC mode: {history_pc['loss'][0]:.4f} → {history_pc['loss'][-1]:.4f} (Δ={loss_improve_pc:.4f})")
    print(f"  EP mode: {history_ep['loss'][0]:.4f} → {history_ep['loss'][-1]:.4f} (Δ={loss_improve_ep:.4f})")
    print()
