...
def get_optimizer(
    ...
    **kwargs: Any,
    ...
    if name == "sgd":
        return (
            optim.SGD(params, lr=lr, momentum=momentum, weight_decay=weight_decay),
            False,
        )
    ...
    raise ValueError(
        f"Unknown optimizer: {name}. Available: sgd, adam, adamw, muon, eqprop, smep, sdmep, local_ep, natural_ep"
    )
