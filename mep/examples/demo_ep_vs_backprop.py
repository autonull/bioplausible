...
def main():
    ...
    print()
    print(
        f"{'Optimizer':<12} {'Epoch 1':<12} {'Epoch 3':<12} {'Epoch 5':<12} {'Avg Time':<12}"
    )
    print("-" * 70)
    ...
    print(
        f"{'SGD':<12} {sgd_results[0]:.2%}{'':<8} {sgd_results[2]:.2%}{'':<8} {sgd_results[4]:.2%}{'':<8} ~2.0s"
    )
    print(
        f"{'Adam':<12} {adam_results[0]:.2%}{'':<8} {adam_results[2]:.2%}{'':<8} {adam_results[4]:.2%}{'':<8} ~2.0s"
    )
