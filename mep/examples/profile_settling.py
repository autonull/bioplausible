...
def profile_settling():
    ...
    for _ in range(3):
        _ = settler.settle(
            model, x, y, beta=0.3, energy_fn=energy_fn, structure=structure
        )
...
def benchmark_adaptive_vs_fixed():
    ...
    print(
        f"Adaptive settling (early stop): {adaptive_time*1000:.1f}ms for 50 iterations"
    )
