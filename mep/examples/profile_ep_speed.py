...
def main():
    ...
    for steps in [5, 10, 15, 20, 30]:
        ...
        print(
            f"{steps:<8} {ep_time:<12.2f} {ratio:<10.1f}x {per_step:<12.2f}ms {settling_pct:<10.1f}%"
        )
    ...
    for batch in [16, 32, 64, 128]:
        ...
        print(
            f"{batch:<8} {bp_time2:<12.2f} {ep_time2:<12.2f} {ep_time2/bp_time2:<10.1f}x"
        )
    ...
    for depth in [3, 5, 10, 20]:
        ...
        print(
            f"{depth:<8} {bp_time3:<12.2f} {ep_time3:<12.2f} {ep_time3/bp_time3:<10.1f}x"
        )
